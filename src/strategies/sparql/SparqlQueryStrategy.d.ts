...
export declare class SparqlQueryStrategy extends QueryStrategy {
  ...
  protected spreadProjections(
    ...
    overriddenSubject?: Option<string>
  ): string;
  ...
  protected addPageInfoIfNeeded(
    actualNumberOfResults?: number
  ): OrderedMap<
    string,
    {
      hasNextPage: boolean;
