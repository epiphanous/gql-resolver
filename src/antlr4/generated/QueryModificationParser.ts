...
export class QueryModificationParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		...
		"textMatchParam", "boost", "binding", "expressionList", "featureOrLatLon", 
		"proximitySpec", "functionCall", "rdfLiteral", "numericLiteral", "varRef", 
	...
	private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
		...
		undefined, undefined, undefined, undefined, undefined, undefined, undefined, 
		undefined, undefined, undefined, undefined, undefined, undefined, undefined, 
		undefined, undefined, undefined, undefined, "ABS", "AND", "AS", "ASC", 
		"BIND", "BNODE", "BOOST", "BOUND", "CEIL", "COALESCE", "CONCAT", "CONTAINS", 
		"DATATYPE", "DAY", "DESC", "ENCODE_FOR_URI", "EXISTS", "FALSE", "FLOOR", 
		"GEOMATCH", "HOURS", "IF", "IF_FOLLOWED_BY", "IF_FOLLOWS", "IN", "IRI", 
		"ISBLANK", "ISIRI", "ISLITERAL", "ISNUMERIC", "ISURI", "LANG", "LANGMATCHES", 
		"LATLON", "LCASE", "LOSS_TO", "MAX_HITS", "MD5", "MIN_SCORE", "MINUTES", 
		"MONTH", "NEAR", "NOT", "NOW", "OBFUSCATE", "OF", "OR", "RAND", "REGEX", 
		"REPLACE", "ROUND", "SAMETERM", "SECONDS", "SHA1", "SHA256", "SHA384", 
		"SHA512", "STR", "STRAFTER", "STRBEFORE", "STRDT", "STRENDS", "STRLANG", 
		"STRLEN", "STRSTARTS", "STRUUID", "SUBJECT", "SUBSTR", "TEXTMATCH", "TIMEZONE", 
		"TO_UNIT", "TRUE", "TZ", "UCASE", "URI", "UUID", "WITHIN", "YEAR", "YOU_MAY_KNOW", 
		"IRI_REF", "PNAME_NS", "PNAME_LN", "BLANK_NODE_LABEL", "LANGTAG", "INTEGER", 
		"DECIMAL", "DOUBLE", "EXPONENT", "STRING_LITERAL1", "STRING_LITERAL2", 
		"ECHAR", "EMPTY_PARENS", "ANON", "VARNAME", "PN_PREFIX", "PN_LOCAL", "WS",
	];
	...
	public builtinCall(): BuiltinCallContext {
		...
		try {
			...
			case QueryModificationParser.EXISTS:
				...
				this.state = 277;
				_la = this._input.LA(1);
				if (!(_la === QueryModificationParser.T__1 || _la === QueryModificationParser.T__5)) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
				...
				this.state = 287;
				_la = this._input.LA(1);
				if (!(_la === QueryModificationParser.T__2 || _la === QueryModificationParser.T__6)) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
	...
	public comparisonOp(): ComparisonOpContext {
		...
		try {
			...
			this.state = 653;
			_la = this._input.LA(1);
			if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << QueryModificationParser.T__7) | (1 << QueryModificationParser.T__10) | (1 << QueryModificationParser.T__11) | (1 << QueryModificationParser.T__12) | (1 << QueryModificationParser.T__13) | (1 << QueryModificationParser.T__14) | (1 << QueryModificationParser.T__15) | (1 << QueryModificationParser.T__16) | (1 << QueryModificationParser.T__17) | (1 << QueryModificationParser.T__18))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public unaryOp(): UnaryOpContext {
		...
		try {
			...
			this.state = 655;
			_la = this._input.LA(1);
			if (!(_la === QueryModificationParser.T__19 || _la === QueryModificationParser.T__20)) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public factorOp(): FactorOpContext {
		...
		try {
			...
			this.state = 657;
			_la = this._input.LA(1);
			if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << QueryModificationParser.T__21) | (1 << QueryModificationParser.T__22) | (1 << QueryModificationParser.T__23))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	private static readonly _serializedATNSegment0: string =
		...
		"kl\x04\x02mmww\x02\u02FD\x02P\x03\x02\x02\x02\x04S\x03\x02\x02\x02\x06" +
		"]\x03\x02\x02\x02\bg\x03\x02\x02\x02\nq\x03\x02\x02\x02\f{\x03\x02\x02" +
		"\x02\x0E\x7F\x03\x02\x02\x02\x10\x97\x03\x02\x02\x02\x12\x99\x03\x02\x02" +
		"\x1A\x0E\x07\xC9\xD0\x03\x02\x02\x02\xCA\xD0\x05\x1C\x0F\x02\xCB\xCC\x07" +
		"\x04\x02\x02\xCC\xCD\x05\x1A\x0E\x02\xCD\xCE\x07\x05\x02\x02\xCE\xD0\x03" +
		"\x02\x02\x02\xCF\xC6\x03\x02\x02\x02\xCF\xCA\x03\x02\x02\x02\xCF\xCB\x03" +
		"\x02\x02\x02\xD0\xDB\x03\x02\x02\x02\xD1\xD2\f\x06\x02\x02\xD2\xD3\x05" +
		"<\x1F\x02\xD3\xD4\x05\x1A\x0E\x07\xD4\xDA\x03\x02\x02\x02\xD5\xD6\f\x05" +
		"\x02\x02\xD6\xD7\x05> \x02\xD7\xD8\x05\x1A\x0E\x06\xD8\xDA\x03\x02\x02" +
		"\x02\xD9\xD1\x03\x02\x02\x02\xD9\xD5\x03\x02\x02\x02\xDA\xDD\x03\x02\x02" +
		"\x02\xDB\xD9\x03\x02\x02\x02\xDB\xDC\x03\x02\x02\x02\xDC\x1B\x03\x02\x02" +
		"\x02\xDD\xDB\x03\x02\x02\x02\xDE\xE8\x05\x1E\x10\x02\xDF\xE8\x05.\x18" +
		"\x02\xE0\xE8\x050\x19\x02\xE1\xE8\x05@!\x02\xE2\xE8\x052\x1A\x02\xE3\xE8" +
		"\x05D#\x02\xE4\xE8\x05J&\x02\xE5\xE8\x056\x1C\x02\xE6\xE8\x054\x1B\x02" +
		"\xE7\xDE\x03\x02\x02\x02\xE7\xDF\x03\x02\x02\x02\xE7\xE0\x03\x02\x02\x02" +
		"\xE7\xE1\x03\x02\x02\x02\xE7\xE2\x03\x02\x02\x02\xE7\xE3\x03\x02\x02\x02" +
		"\xE7\xE4\x03\x02\x02\x02\xE7\xE5\x03\x02\x02\x02\xE7\xE6\x03\x02\x02\x02" +
		"\xE8\x1D\x03\x02\x02\x02\xE9\xEA\x07\x1B\x02\x02\xEA\xEB\x07\x04\x02\x02" +
		"\xEB\xEC\x05\x1A\x0E\x02\xEC\xED\x07\x05\x02\x02\xED\u0212\x03\x02\x02" +
		"\x02\xEE\xEF\x07\"\x02\x02\xEF\xF0\x07\x04\x02\x02\xF0\xF1\x056\x1C\x02" +
		"\xF1\xF2\x07\x05\x02\x02\xF2\u0212\x03\x02\x02\x02\xF3\xF4\x07#\x02\x02" +
		"\xF4\xF5\x07\x04\x02\x02\xF5\xF6\x05\x1A\x0E\x02\xF6\xF7\x07\x05\x02\x02" +
		"\xF7\u0212\x03\x02\x02\x02\xF8\xF9\x07$\x02\x02\xF9\xFA\x07\x06\x02\x02" +
		"\xFA\xFB\x05F$\x02\xFB\xFC\x07\x07\x02\x02\xFC\xFD\x05(\x15\x02\xFD\u0212" +
		...
		"\x02\x02\u0211\u01BA\x03\x02\x02\x02\u0211\u01C1\x03\x02\x02";
	private static readonly _serializedATNSegment1: string =
		"\x02\u0211\u01C8\x03\x02\x02\x02\u0211\u01CF\x03\x02\x02\x02\u0211\u01D6" +
		"\x03\x02\x02\x02\u0211\u01DD\x03\x02\x02\x02\u0211\u01E2\x03\x02\x02\x02" +
		"\u0211\u01E9\x03\x02\x02\x02\u0211\u01EB\x03\x02\x02\x02\u0211\u01F6\x03" +
		"\x02\x02\x02\u0211\u01FB\x03\x02\x02\x02\u0211\u0200\x03\x02\x02\x02\u0211" +
